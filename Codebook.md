...
https://github.com/borcsa/GettingAndCleaningData .
...
- 3-563: Feature variables - see detailed description below under "Feature Selection". Features are normalized and bounded within [-1,1].
...
The set of variables to be found in the tidy data: 
